...
<html>
	...
	<table border="1" width="800">
				<tr><td rowspan="9"><img src="<c:url value='/images/${prd.prdImg }'/>" width="300" height="150"></td></tr>
				<tr><td>상품번호 </td>
				...
				<!-- 로그인 하지 않은 경우에는[장바구니][주문하기]버튼 출력 -->
	    ...
	    <a href="<c:url value='/product/productCtgList/${prd.ctgId}'/>"><button>상품 목록 보기</button></a><br>
